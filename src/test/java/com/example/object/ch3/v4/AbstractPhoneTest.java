...
class AbstractPhoneTest {
	...
	void calculateFeeByRegularPhone() {
		...
		AbstractPhone phone = new RegularPhone(10L, Duration.ofSeconds(10));
		phone.call(call);
	...
	@Test
	void calculateFeeByTaxableRegularPhone() {
		Call call = new Call(
			LocalDateTime.of(2024, 1, 1, 12, 10, 0),
			LocalDateTime.of(2024, 1, 1, 12, 20, 10));
		AbstractPhone phone = new TaxableRegularPhone(10L, Duration.ofSeconds(10), 1.1);
		phone.call(call);
	...
	@Test
	void calculateFeeByTaxableNightlyDiscountPhone() {
		Call call1 = new Call(
			LocalDateTime.of(2024, 1, 1, 22, 10, 0),
			LocalDateTime.of(2024, 1, 1, 22, 11, 0));
		...
		AbstractPhone phone = new TaxableNightlyDiscountPhone(
